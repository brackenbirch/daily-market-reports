...
on:
  schedule:
    # Runs at 11:00 AM UTC daily (changed from 12:00 PM)
    - cron: '0 11 * * *'
...
jobs:
  generate-market-report:
    ...
    - name: Generate and Email Market Report
      ...
      run: node generate-report-enhanced.js --now
    ...
    - name: Commit and push report
      run: |
        ...
        git commit -m "Daily market report - $(date +'%Y-%m-%d %H:%M UTC')" || echo "No changes to commit"
